...
base_model_dir = os.path.basename("C:/Users/Dell/Desktop/S/hackathon/intel/data/ssdlite_mobilenet_v2_coco_2018_05_09")
tf_model_path=os.path.basename("C:/Users/Dell/Desktop/S/hackathon/intel/data/ssdlite_mobilenet_v2_coco_2018_05_09/saved_model/saved_model.pb")
...
#     utils.download_file(model_url, downloaded_model_path.name,
#                         downloaded_model_path.parent)

# # Unpack the model
# tf_model_path = base_model_dir / \
#     archive_name.with_suffix("").stem / "frozen_inference_graph.pb"
# if not tf_model_path.exists():
#     with tarfile.open(downloaded_model_path) as file:
#         file.extractall(base_model_dir)

converted_model_path = tf_model_path
precision = "FP16"
